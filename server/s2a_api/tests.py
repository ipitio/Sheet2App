...
class ApplicationModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Application.objects.create(creator=creator, name="Test App", role_mem_url="https://www.google.com", is_published=False)
...
class DatasourceModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        app = Application.objects.create(creator=creator, name="Test App", role_mem_url="https://www.google.com", is_published=False)
...
class DatasourceColumnModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        app = Application.objects.create(creator=creator, name="Test App", role_mem_url="https://www.google.com", is_published=False)
        data = Datasource.objects.create(app=app, spreadsheet_id="1", gid=1, name="Test Data")
        DatasourceColumn.objects.create(datasource=data, column_index=1, name="Test Column", initial_value="Test Value", value_type="text", is_link_text=False, is_table_ref=False, is_filter=False, is_user_filter=False, is_edit_filter=False)
...
class TableViewPermModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        TableViewPerm.objects.create(table_view=table, role="Test Role", can_view=True, can_delete=False, can_add=False)
...
class DetailViewPermModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        data = Datasource.objects.create(app=app, spreadsheet_id="1", gid=1, name="Test Data")
        table = TableView.objects.create(app=app, name="Test Table", datasource=data)
        detail = DetailView.objects.create(table_view=table, name="Test Detail", record_index=2)
        DetailViewPerm.objects.create(detail_view=detail, role="Test Role")

    def test_fields(self):
        perm = DetailViewPerm.objects.get(id=1)
        self.assertEquals(perm.detail_view.table_view.app.creator.email, 'perm@detail.com')
        self.assertEquals(perm.role, 'Test Role')
...
class TableViewColumnModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        app = Application.objects.create(creator=creator, name="Test App", role_mem_url="https://www.google.com", is_published=False)
        data = Datasource.objects.create(app=app, spreadsheet_id="1", gid=1, name="Test Data")
        col = DatasourceColumn.objects.create(datasource=data, column_index=1, name="Test Column", initial_value="Test Value", value_type="text", is_link_text=False, is_table_ref=False, is_filter=False, is_user_filter=False, is_edit_filter=False)
        table = TableView.objects.create(app=app, name="Test Table", datasource=data)
...
class DetailViewColumnModelTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        table = TableView.objects.create(app=app, name="Test Table", datasource=data)
        detail = DetailView.objects.create(table_view=table, name="Test Detail", record_index=2)
        DetailViewEditableColumn.objects.create(detail_view=detail, datasource_column=col)

    def test_fields(self):
        col = DetailViewEditableColumn.objects.get(id=1)
        self.assertEquals(col.detail_view.table_view.app.creator.email, 'col@detail.com')
        self.assertEquals(col.datasource_column.name, 'Test Column')
