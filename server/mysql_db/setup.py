...
def create_tables():
    ...
    create_creator = (
        "CREATE TABLE Creator (" "id INT PRIMARY KEY AUTO_INCREMENT, " "email TEXT)"
    )
    ...
    create_spreadsheet = (
        "CREATE TABLE Spreadsheet (" "id INT PRIMARY KEY AUTO_INCREMENT," "url TEXT)"
    )
